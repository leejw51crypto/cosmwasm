...
import (
	...
	"github.com/myid/myapple/x/myapple"
	myapplekeeper "github.com/myid/myapple/x/myapple/keeper"
	myappletypes "github.com/myid/myapple/x/myapple/types"
...
const appName = "myapple"

var (
	DefaultCLIHome = os.ExpandEnv("$HOME/.myapplecli")
	DefaultNodeHome = os.ExpandEnv("$HOME/.myappled")
...
type NewApp struct {
	*bam.BaseApp
	...
	myappleKeeper myapplekeeper.Keeper
...
func NewInitApp(
	...
	app.myappleKeeper = myapplekeeper.NewKeeper(
		app.bankKeeper,
		app.cdc,
		keys[myappletypes.StoreKey],
	)
...
type WasmWrapper struct { Wasm wasm.Config `mapstructure:"wasm"`}
	...
	app.mm = module.NewManager(
		...
		myapple.NewAppModule(app.myappleKeeper, app.bankKeeper),
